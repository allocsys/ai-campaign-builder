...
export interface JWTPayload {
  sub: string;
  role: "business_owner" | "customer" | "review_team";
  iat: number;
  exp: number;
  [key: string]: unknown;
}
...
export async function signJWT(payload: { sub: string; role: JWTPayload["role"] }, secret: string, expiresInSeconds = 86400 * 7): Promise<string> {
